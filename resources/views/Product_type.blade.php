				...
				<div class="row">
					...
					<div class="col-sm-9">
						<div class="beta-products-list">
							...
							<div class="row">
							<h6>San Pham Khac</h6>
								@foreach ($product_else as $pro_else)

									<div class="col-sm-4">
										<div class="single-item">
											<div class="single-item-header">
												<a href="/detail/{{$pro_else->id}}"><img src="/source/image/product/{{$pro_else->image}}" alt=""></a>
											</div>
											<div class="single-item-body">
												<p class="single-item-title">{{$pro_else->name}}</p>
												<p class="single-item-price">
													<span>${{$pro_else->unit_price}}</span>
												</p>
											</div>
											<div class="single-item-caption">
												<a class="add-to-cart pull-left" href="shopping_cart.html"><i class="fa fa-shopping-cart"></i></a>
