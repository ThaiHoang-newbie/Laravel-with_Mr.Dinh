					...
					<div class="beta-comp">
						<div class="cart">
							...
							<div class="beta-dropdown cart-body">
								...
								<div class="cart-item">
									<div class="media">
										<a class="pull-left" href="#"><img src="sorce/assets/dest/images/products/cart/2.png" alt=""></a>
										<div class="media-body">
											<span class="cart-item-title">Sample Woman Top</span>
											<span class="cart-item-options">Size: XS; Colar: Navy</span>
											<span class="cart-item-amount">1*<span>$49.50</span></span>
									...
									<div class="col-sm-3">
										<div class="single-item">
											...
											<div class="single-item-header">
												<a href="/detail/{{$new_pro->id}}"><img src="source//image/product/{{$new_pro->image}}" alt=""></a>
											</div>
											<div class="single-item-body">
												<p class="single-item-title">{{$new_pro->name}}</p>
												<p class="single-item-price">
													<span class="flash-del">${{$new_pro->unit_price}}</span>
													<span class="flash-sale">${{$new_pro->promotion_price}}</span>
												</p>
											</div>
											<div class="single-item-caption">
												<a class="add-to-cart pull-left" href="shopping_cart.html"><i class="fa fa-shopping-cart"></i></a>
												<a class="beta-btn primary" href="/detail/{{$new_pro->id}}">{{$new_pro->description}} <i class="fa fa-chevron-right"></i></a>
												<div class="clearfix"></div>
											</div>
										</div>
									</div>
							...
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="shopping_cart.html"><i class="fa fa-shopping-cart"></i></a>
											<a class="beta-btn primary" href="/detail/{{$pro->id}}">{{$pro->description}}<i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>
